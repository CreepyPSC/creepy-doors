local tool = game:GetObjects("rbxassetid://12931782775")[1]
...
tool.Activated:Connect(function()
    if using == false then
        ...
        game.Players.LocalPlayer.Character.Humanoid:SetAttribute("SpeedBoost", getgenv().CustomIcecream.SpeedBoost + OldSpeedBoost)
        task.wait(getgenv().CustomIcecream.EffectDuration)

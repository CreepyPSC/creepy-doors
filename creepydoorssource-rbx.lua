...
local DeathFarmingNotif = OtherTab:CreateParagraph({Title = "Death Farmer", Content = "Use this Death Farmer to AFK grind deaths, Please have 1 revive before starting."})
...
local EntityWarning = OtherTab:CreateParagraph({Title = "Note", Content = "Our entity spawner no longer works, Please use Plamen6789's entity spawner. There is a button below!"})
local Plamen6789BUTTON = GuisTab:CreateButton({

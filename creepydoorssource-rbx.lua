...
-- [[ Script Data / Rayfield UI Library]]
local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Rayfield/main/source'))()
local onlineVersion, scriptDiscord = loadstring(game:HttpGet('https://raw.githubusercontent.com/CreepyPSC/creepy-doors/main/creepy-doorsdata.lua'))()
local scriptVersion = 2.0;
local scriptKey = "creepyontop123@123.yes"
getgenv().myspecialdoorskeyhehe = false;

-- [[ Script Loading ]]
if onlineVersion == nil then
	message("Failed to fetch script version, Please join our discord for support. discord.gg/"..tostring("BHQD5vvNxs"), 10)
	promptdiscord("BHQD5vvNxs")
	return
end
if game.PlaceId ~= 6839171747 and game.PlaceId ~= 6516141723 then
	message("This script only works in doors, Please retry.", 10)
	wait(1)
	message("If you are in a doors then please report this issue to our discord. discord.gg/"..tostring(discordCode), 15)
	promptdiscord()
	return
elseif game.PlaceId == 6516141723 then
	message("Please start a match before executing the script.", 15)
	return
end
if scriptVersion ~= onlineVersion then
	message("Your script is out of date, Please get a new script from our discord. discord.gg/"..tostring(discordCode))
	promptdiscord()
	return
end
if getgenv().myspecialdoorskeyhehe == true then
	message("You have already executed the script, If it hasn't loaded then join our discord. discord.gg/"..tostring(discordCode))
	promptdiscord()
	return
end
...
local FarmingLabel = AutoFarmingTab:CreateSection("Farming")
...
local DeathFarming = AutoFarmingTab:CreateButton({
	...
	Callback = function()
        game:GetService("ReplicatedStorage").EntityInfo.CheckRevive.Name = "reviveshat"
...
-- [[  Credits  ]] --
local CreditLabel = CreditsTab:CreateSection("Credits")
...
-- [[  Other Guis  ]] --
local OtherLabel = GuisTab:CreateSection("Other GUIS")

...
function DamagePlayer(damage)
    ...
    if game.Players.LocalPlayer.Character.Humanoid.Health <= 0 then
	    game.ReplicatedStorage.GameStats["Player_"..game.Players.LocalPlayer.Name].Total.DeathCause.Value = "A-90"
    	game.ReplicatedStorage.GameStats["Player_"..game.Players.LocalPlayer.Name].Total.DeathReason.Value = "A-90"
    end
end
